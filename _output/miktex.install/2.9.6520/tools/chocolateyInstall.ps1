...
$Url = Get-RedirectedURL http://mirrors.ctan.org/systems/win32/miktex/setup/basic-miktex-2.9.6520.exe

$Url64 = Get-RedirectedURL http://mirrors.ctan.org/systems/win32/miktex/setup/basic-miktex-2.9.6520-x64.exe
...
Get-ChocolateyWebFile $packageName $filePath $Url $Url64 -Checksum 43f76ff5392313b1a3ec483fa01390d5392037701bd4ecb33bee3dca74c443a6 -ChecksumType 'sha256' -Checksum64 eacb2024436403c1182d0aace7c62c9fbffed12d4b7391fff8dec9449bb128a9 -ChecksumType64 'sha256'
