...
$Url = Get-RedirectedURL http://mirrors.ctan.org/systems/win32/miktex/setup/windows-x86/basic-miktex-2.9.6643.exe

$Url64 = Get-RedirectedURL http://mirrors.ctan.org/systems/win32/miktex/setup/windows-x64/basic-miktex-2.9.6643-x64.exe
...
Get-ChocolateyWebFile $packageName $filePath $Url $Url64 -Checksum f780eb11305757ec1567ed70be46d45d857fa59454d8874c6be45f9c95d18d7a -ChecksumType 'sha256' -Checksum64 792983b8945ddafc5285cb9942d9d88550ef3af0f8d4add9acd057233ff84584 -ChecksumType64 'sha256'
