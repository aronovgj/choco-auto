...
$url = 'http://download.wsusoffline.net/wsusoffline1073.zip'
$destdir = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
Install-ChocolateyZipPackage "$packageName" "$url" "$destdir" -Checksum 1f34f152b535d351fa5f4f30abfcc07a8ebfde86d58023a3248f66f67712c3e4 -ChecksumType 'sha256'
