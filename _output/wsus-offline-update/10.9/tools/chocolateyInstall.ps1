...
$url = 'http://download.wsusoffline.net/wsusoffline109.zip'
$destdir = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
Install-ChocolateyZipPackage "$packageName" "$url" "$destdir" -Checksum e25b6bfc85927fab5ee5aeddf8d19540a2fb688960b3cdef4756ad9759b3da43 -ChecksumType 'sha256'
